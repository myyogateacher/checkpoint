...
const COLORS: Record<ColorKey, { badge: string; dot: string }> = {
  sky: { badge: 'border-sky-200/70 bg-sky-50/80 text-sky-700', dot: 'bg-sky-500' },
  amber: { badge: 'border-amber-200/70 bg-amber-50/80 text-amber-700', dot: 'bg-amber-500' },
  yellow: { badge: 'border-yellow-300/70 bg-yellow-50/80 text-yellow-700', dot: 'bg-yellow-500' },
  rose: { badge: 'border-rose-200/70 bg-rose-50/80 text-rose-700', dot: 'bg-rose-500' },
  blue: { badge: 'border-blue-200/70 bg-blue-50/80 text-blue-700', dot: 'bg-blue-600' },
  violet: { badge: 'border-violet-200/70 bg-violet-50/80 text-violet-700', dot: 'bg-violet-500' },
  emerald: { badge: 'border-emerald-200/70 bg-emerald-50/80 text-emerald-700', dot: 'bg-emerald-500' },
  teal: { badge: 'border-teal-200/70 bg-teal-50/80 text-teal-700', dot: 'bg-teal-500' },
}
...
export const ENGINES: Record<DatabaseEngine, EngineMeta> = {
  ...
  redis: { label: 'Redis', category: 'nosql', defaultPort: 6379, dialect: null, query: false, migrations: false, color: 'rose' },
